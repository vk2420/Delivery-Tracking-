...
const Dashboard: React.FC = () => {
  ...
  const [activeView, setActiveView] = useState<'dashboard' | 'tracking'>('dashboard');
  ...
  return (
    <div className="max-w-7xl mx-auto p-6">
      ...
      <div className="mb-8">
        ...
        <p className="text-gray-600 mb-6">Monitor and manage delivery statuses with cluster and concept filtering</p>

        {/* Navigation Tabs */}
        <div className="flex space-x-4 border-b border-gray-200">
          <button
            onClick={() => setActiveView('dashboard')}
            className={`pb-2 px-4 font-medium text-sm transition-colors relative ${activeView === 'dashboard'
          ...
          <button
            ...
            className={`pb-2 px-4 font-medium text-sm transition-colors relative ${activeView === 'tracking'
              ? 'text-blue-600 border-b-2 border-blue-600'
              : 'text-gray-500 hover:text-gray-700'
              }`}
          >
